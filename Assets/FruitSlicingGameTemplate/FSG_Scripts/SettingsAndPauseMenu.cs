...
public class SettingsAndPauseMenu : MonoBehaviour
{
    ...
    private Text menuScoreField;                                        // the field that shows the player score
    private Text menuLevelField;                                        // the field that shows the player score
    ...
    public Slider musicOnOffSlider;                                     // the UI Slider we use to Show the toggled state of the Musics On/OFF (in settings menu pop-up)       
    ...
    void Start()
    {
        ...
        // invokeRepeat the FNC_SlowUpdate method so that we can run "less-critical" methods/actions inside of that loop.
        InvokeRepeating("FNC_SlowUpdate", 0.25f, 0.25f);
    ...
    public void PauseGame()
    {
        ...
        {
            if (FreezeEffect.instance != null && FreezeEffect.instance.freezeEffectIsOn)
            {
                Time.timeScale = 0.6f;
            }
            else
    ...
    private void UpdateUIText()
    {
        ...
        //the players "level".. which levels up every 500 fruit. Obviously for a production game you would setup 
    ...
    public void FaderExitApplication()
    {
        ...
        //we change Static Var FruitMissed to zero...
