...
public class ScreenFaderSingleton : Singleton<ScreenFaderSingleton>
{
    ...
    /// amount of work to amend the SingletonScreenFader for use in FruitNinjaClone, because there are several additional
    /// scenes.
    /// </summary>
    ...
    /// <summary>
    /// This method added to ScreenFaderSingleton for FNC.  This will load the Main Menu Scene (1) if you are
    ...
    public void ZeroOutPlayerScore()
    {
        ...
        //commenting out.. not used in FNC GameTemplate
